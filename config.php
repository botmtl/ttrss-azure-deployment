<?php
    ...
    preg_match_all($re, $MYSQLCONNSTR, $matches, PREG_SET_ORDER, 0);
    define('DB_TYPE', 'mysql');
    define('DB_HOST', $matches[0]['DB_HOST']);
    define('DB_USER', $matches[0]['DB_USER']);
    define('DB_NAME', $matches[0]['DB_NAME']);
    define('DB_PASS', $matches[0]['DB_PASS']);
    define('DB_PORT', $matches[0]['DB_PORT']);
